...
const workoutData = [
  {
    ...
    description: "A complete workout targeting all major muscle groups for overall strength and endurance. This balanced routine hits every major muscle group in your body.",
    duration_minutes: 45,
    difficulty_level: "Intermediate",
    exercise_type: "Strength",
    muscle_groups: ["Full Body"],
    equipment_needed: ["None", "Dumbbells (optional)"],
    exercises: sampleExercises.fullBody
  },
  {
    id: "2",
    name: "Upper Body Blast",
    description: "An intense workout focusing on chest, back, shoulders, and arms to build upper body strength and definition. Perfect for developing a strong and defined upper body.",
    duration_minutes: 30,
    difficulty_level: "Advanced",
    exercise_type: "Strength",
    muscle_groups: ["Chest", "Back", "Shoulders"],
    equipment_needed: ["Dumbbells", "Bench"],
    exercises: sampleExercises.upperBody
  },
  {
    id: "3",
    name: "Core Crusher",
    description: "A targeted abdominal and core workout to strengthen your midsection, improve stability, and define your abs. This routine will help you build a strong and stable core.",
    duration_minutes: 20,
    difficulty_level: "Beginner",
    exercise_type: "Strength",
    muscle_groups: ["Core"],
    equipment_needed: ["None", "Exercise Mat"],
    exercises: sampleExercises.core
  },
  {
    id: "4",
    name: "HIIT Cardio",
    description: "A high-intensity interval training workout designed to burn calories and improve cardiovascular fitness. This session will get your heart pumping and maximize calorie burn.",
    duration_minutes: 25,
    difficulty_level: "Intermediate",
    exercise_type: "Cardio",
    muscle_groups: ["Full Body"],
    equipment_needed: ["None", "Jump Rope (optional)"],
    exercises: sampleExercises.cardio
  },
  {
    id: "5",
    name: "Lower Body Focus",
    description: "A comprehensive leg and glute workout to build strength and shape your lower body. This routine targets all the major muscles in your lower half for balanced development.",
    duration_minutes: 40,
    difficulty_level: "Beginner",
    exercise_type: "Strength",
    muscle_groups: ["Legs", "Glutes"],
    equipment_needed: ["Dumbbells", "Exercise Mat"],
    exercises: sampleExercises.lowerBody
  },
  {
    id: "6",
    name: "Flexibility Flow",
    description: "A gentle sequence of stretching exercises to improve flexibility, mobility, and reduce muscle tension. Perfect for recovery days or as a complement to more intense workouts.",
    duration_minutes: 35,
    difficulty_level: "Beginner",
...
export const getSampleWorkout = (id: string) => {
  // Try to find the workout with the matching ID
  const workout = workoutData.find(w => w.id === id);
  
  // If found, return it; otherwise, return the first workout as a fallback
  return workout || workoutData[0];
};
